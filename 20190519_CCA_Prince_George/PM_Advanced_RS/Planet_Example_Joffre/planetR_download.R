...
# Set API
setwd("C:/Users/bevington/Desktop/planet_CCA_joffre")
getwd()
...
# Date range of interest
  ...
  ### Specify Date  
  date_start = as.Date('2019-05-01') #paste0(start_year,"-01-01"))+start_doy
  date_end   = as.Date('2019-05-08') #paste0(end_year,"-01-01"))+end_doy
...
# Set AOI
my_aoi       = read_sf("C:/Users/bevington/Dropbox/FLNRO_p1/Programming/bevirepo/rs_training/20190519_CCA_Prince_George/PM_Advanced_RS/Code/outline.kml") # Import from KML or other
